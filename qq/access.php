...
$parameters['oauth_vericode'] = $_REQUEST['oauth_vericode'];
...
$parameters = array();
$parameters['openid'] = $params['openid'];
$acc_token = new OAuthConsumer($token, $token_secret);
$acc_req = OAuthRequest::from_consumer_and_token($consumer, $acc_token, "GET", $url,$parameters);
...
$response = $curl->get($acc_req->to_url());
